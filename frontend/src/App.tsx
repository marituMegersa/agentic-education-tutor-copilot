...
export default function App() {
  ...
  return (
    <div style={{ padding: '2rem', fontFamily: 'sans-serif', maxWidth: '800px', margin: '0 auto' }}>
      <h1>Agentic AI Personalized Education Tutor Copilot</h1>
      <p style={{ color: '#666' }}>Multi-agent adaptive learning assistant, interactive quiz generator, concept explainer, and student progress tracker.</p>
