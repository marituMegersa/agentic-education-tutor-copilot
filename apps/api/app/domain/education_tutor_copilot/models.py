...
class AgenticEducationTutorCopilotSession(Base):
    __tablename__ = "education_tutor_copilot_sessions"
...
class AgenticEducationTutorCopilotItem(Base):
    __tablename__ = "education_tutor_copilot_items"

    id = Column(String, primary_key=True, index=True)
    session_id = Column(String, ForeignKey("education_tutor_copilot_sessions.id"))
